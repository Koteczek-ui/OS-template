...
void parse_cmd(char* cmd) {
    ...
    if (strcmp(cmd, "hlt") == 0 || strcmp(cmd, "halt") == 0) asm volatile ("hlt");
    ...
    else if (strncmp(cmd, "echo \"", 6) == 0) handle_print_logic(cmd + 6);
        ...
        help_cmd_helper("cls/clear 0xCC", "Clear screen with color");
        help_cmd_helper("kprint/echo \"text\" 0xCC", "Print text with color");
        
        help_cmd_category_splitter_c("Keyboard & Navigation");
        help_cmd_helper("UP/DOWN arrows", "Browse command history");
